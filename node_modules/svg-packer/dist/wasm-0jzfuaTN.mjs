...
const UTF8Decoder = typeof TextDecoder != "undefined" ? new TextDecoder() : void 0;
...
function usesDestructorStack(argTypes) {
	for (let i = 1; i < argTypes.length; ++i) if (argTypes[i] !== null && argTypes[i].destructorFunction === void 0) return true;
	return false;
}
...
function heap32VectorToArray(count, firstElement) {
	const array = [];
	for (let i = 0; i < count; i++) array.push(HEAPU32[firstElement + i * 4 >> 2]);
	return array;
}
...
function ttf2woff2(inputContent) {
	...
	for (let i = 0; i < outputSize; i++) outputContent[i] = Module.getValue(outputBufferPtr + i, "i8");
	Module.freePtrs(outputBufferPtr, outputSizePtr);
	return outputContent;
}

//#endregion
export { initWasmBrowser, ttf2woff2 };